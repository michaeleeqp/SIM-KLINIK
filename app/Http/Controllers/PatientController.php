...
class PatientController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'no_ktp' => 'nullable|digits:16|unique:patients,no_ktp,' . $patient->id,
            ...
            'no_wa' => 'nullable|digits_between:10,13',
        ...
        // Ensure tanggal_lahir stored as Y-m-d if provided
    ...
    public function search(Request $request)
    {
        ...
        // Serialize patient and ensure tanggal_lahir is in ISO format (Y-m-d)
        $data = $patient->toArray();
        $data['tanggal_lahir'] = $patient->tanggal_lahir ? \Carbon\Carbon::parse($patient->tanggal_lahir)->format('Y-m-d') : null;
