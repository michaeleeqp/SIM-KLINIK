...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Poliklinik Umum — Asuhan Medis</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mt-3">
                    ...
                    <form id="poliklinikForm" action="{{ route('poliklinik.assessments.store', ['poli' => 'umum']) }}" method="POST">
                        @csrf
       ...
       oninput="this.value = this.value.replace(/[^0-9\/]/g, '')">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="repirasi" 
